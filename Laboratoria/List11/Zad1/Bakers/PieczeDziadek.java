...
public class PieczeDziadek extends Ciasto implements Serializable {
    ...
    private static final String APPLEPIE_MESSAGE = "Ciasto pieczone przez dziadka to szarlotka.";
    private static final String PLUMCAKE_MESSAGE = "Ciasto pieczone przez dziadka to ciasto sliwkowe.";
    ...
    public PieczeDziadek(int whoChoice, int howChoice) {
    ...
    public void wyswietlInfo() {
        switch (whoChoice) {
            ...
            case 2:
                ...
                break;
            default:
                System.out.println("Dziadek mial piec ciasto, ale nie wie jak.");
        }
    }
    ...
    private void printTypeOfCake(String type) {
        System.out.println("Dziadek piecze ciasto. " + type);
    }
