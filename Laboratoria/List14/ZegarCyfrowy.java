...
public class ZegarCyfrowy implements Observer {
    ...
    public ZegarCyfrowy(Zegar observedClock) {
        clock = observedClock;
    ...
    public String toString() {
        String timeToPrint = "\tczas= " + secondsFromMidnight + "\t\tZegar Cyfrowy";
    ...
    public void update(int hh, int mm, int ss) {
        secondsFromMidnight = hh * SECONDS_PER_HOUR + mm * MINUTES_PER_HOUR + ss;
        print();
    }
